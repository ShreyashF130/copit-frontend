...
//       {/* --- PROBLEM/SOLUTION: RELATABLE STORY --- */}
...
//                 Powerful Features
//              </div>
//              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900 dark:text-white">Your Store on <span className="text-indigo-600">Steroids.</span></h2>
...
//              {/* Feature 1: Payment Fallback (Large Card) */}
...
//                 <div className="absolute top-0 right-0 w-64 h-64 bg-red-500/10 blur-[60px] rounded-full pointer-events-none group-hover:bg-red-500/20 transition-all" />
...
//                          <ShieldCheck size={24} />
//                       </div>
//                       <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Never Lose a Sale.</h3>
...
//                         <span className="text-slate-900 dark:text-white font-bold"> "Scan & Upload Screenshot" </span> 
//                         mode so your customer can still pay via UPI.
//                       </p>
//                    </div>
//                    <div className="mt-8 flex gap-2">
//                       <div className="px-3 py-1 bg-red-50 dark:bg-red-900/20 text-red-600 text-xs font-bold rounded-lg border border-red-100 dark:border-red-800">100% Uptime</div>
...
//                   <span className="block mt-2 font-bold text-orange-600">Recovers ~15% of lost sales.</span>
//                 </p>
//              </div>

//              {/* Feature 4: Review Management (Wide Card) */}
...
//                    <div className="flex-1">
//                       <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 rounded-2xl flex items-center justify-center mb-6">
//                          <Star size={24} />
//                       </div>
//                       <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Review Shield</h3>
...
//                       </div>
//                       <div className="flex items-center gap-3 p-3 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/20 opacity-70">
//                         <span className="text-red-400 font-bold text-sm">★☆☆☆☆</span>
//                         <ArrowRight size={14} className="text-slate-300"/>
//                         <span className="text-[10px] font-bold text-red-600 uppercase">Alert Admin</span>
//                       </div>
//                    </div>
//                 </div>
//              </div>
